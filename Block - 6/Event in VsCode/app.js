document.addEventListener("DOMContentLoaded", function () {
    ...
    async function listenToEvents() {
        ...
        // Get all events
        contractInstance.getPastEvents("TokensSent", { fromBlock: 0 }).then((events) => {
            const serializedEvents = safeStringify(events);
            eventResult.innerHTML = serializedEvents + "<br />=====<br />" + eventResult.innerHTML;
        });
    }
  });
